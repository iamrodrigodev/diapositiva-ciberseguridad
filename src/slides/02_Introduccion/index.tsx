...
import ScrambleDemo from './ScrambleDemo'
      ...
      <div className="flex gap-6 flex-1 overflow-hidden">
        <div className="flex-1 flex flex-col gap-4">
          ...
          <motion.div variants={fadeUp} className="rounded-xl px-5 py-4"
            ...
            <p className="text-xs font-mono text-white/30 uppercase tracking-widest mb-2">Tipos de criptografía</p>
            <div className="flex gap-4 flex-wrap">
              <span className="text-sm"><strong className="text-emerald-400">Simétrica</strong> <span className="text-white/40">— misma clave</span></span>
              <span className="text-sm"><strong className="text-violet-400">Asimétrica</strong> <span className="text-white/40">— par pública/privada</span></span>
              <span className="text-sm"><strong className="text-amber-400">Híbrida</strong> <span className="text-white/40">— ambas (TLS, PGP)</span></span>
            </div>
          </motion.div>
        </div>

        <motion.div variants={fadeUp} className="w-[38%] flex items-center">
          <ScrambleDemo />
        </motion.div>
      </div>
    </SlideLayout>
