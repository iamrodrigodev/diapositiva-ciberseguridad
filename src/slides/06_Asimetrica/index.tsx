      ...
      <div className="flex gap-6 flex-1 overflow-hidden mt-2">
        ...
        <motion.div variants={fadeUp} className="w-[45%] flex flex-col gap-3">
          <div className="rounded-3xl p-5 flex-1 flex flex-col gap-3 relative overflow-hidden"
            ...
            <h3 className="font-bold text-[20px] bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">ECC — Curvas Elípticas</h3>
            
            <div className="shrink-0 flex items-center justify-center -mt-2 -mb-2">
              <ECCCanvas />
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-2.5 items-start">
                ...
                <div>
                  ...
                  <p className="text-white/65 text-[13px] leading-snug">
                    Calcular los rebotes hacia adelante es fácil, pero adivinar el punto de origen (clave privada) es imposible.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 mt-auto pt-1">
              {[['RSA-2048', '2048 bits', '#a78bfa', 'rgba(167,139,250,0.06)', 'rgba(167,139,250,0.2)'], ['ECC-256', '256 bits', '#60a5fa', 'rgba(96,165,250,0.06)', 'rgba(96,165,250,0.2)']].map(([name, bits, color, bg, border]) => (
                <div key={name as string} className="rounded-2xl px-4 py-3 transition-all hover:scale-[1.02]"
                  ...
                  <div className="text-[9px] font-bold text-white/40 uppercase tracking-widest mt-2">seguridad eq.</div>
                </div>
              ))}
            </div>
            ...
            <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-2xl p-3 shrink-0">
              ...
              <p className="text-[13px] text-white/60 leading-snug">
                Con claves <strong className="text-white/80">8× más cortas</strong>, ECC ahorra CPU, siendo el estándar para móviles y TLS 1.3.
              </p>
            </div>
